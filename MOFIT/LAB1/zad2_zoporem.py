...
plot_title = "alfa_" + str(alfa) + "_czas_i_polozenie_z_oporem_" +  str(dt) + "s.png"
...
plot_title = "alfa_" + str(alfa) + "_Zestawianie_energii_potencjalnej_i_kinetycznej_zoporem_" +  str(dt) + "_s.png"
plt.savefig(plot_title)
ax1.legend()
"""
...
plot_title = "alfa_" + str(alfa) + "_portret_fazowy_z_oborem_z_krokiem_" +  str(dt) + "_s.png"
plt.savefig(plot_title)
ax1.legend()
